...
_default_artifacts_dir = os.path.join(_dashboard_root, "artifacts")
ARTIFACTS_DIR = os.environ.get("DASHBOARD_ARTIFACTS_DIR", _default_artifacts_dir)
...
def dashboard_page(request):
    return render(request, "dashboard/ml_model_pages/dashboard.html")

@login_required
def executive_summary_page(request):
    return render(request, "dashboard/ml_model_pages/executive_summary.html")
